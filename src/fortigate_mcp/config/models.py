...
class FortiGateDeviceConfig(BaseModel):
    ...
    os_version: str | None = Field(default=None, description="FortiOS version (e.g. '7.6.7', '8.0.1'). Auto-detected on first request if not set. Supports version-aware endpoint routing and compatibility checks.")
