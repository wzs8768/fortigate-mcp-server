...
from ..config.models import AuthConfig, FortiGateDeviceConfig
...
def _load_dot_path_modules(fallback: frozenset[str]) -> frozenset[str]:
    """Composite CMDB modules from the generated catalog, falling back to the
    hand-maintained literal when the data files are not installed."""
    try:
        return api_catalog.composite_modules() | fallback
    except Exception:  # missing/corrupt data file — keep working
        return fallback
...
class FortiGateAPI:
    ...
    def is_version_compatible(self, min_version: str, max_version: str | None = None) -> bool:
    ...
    def _with_version_hint(self, error_msg: str, endpoint: str, method: str) -> str:
        """Add "this endpoint does not exist in FortiOS X" to a raw API error.

        FortiOS answers an unknown path with a bare 404, or with an opaque
        500/-651 on a newer build — neither says "wrong version". When the
        detected version is known and the catalog says the endpoint is absent
        from that release, say so explicitly.
        """
        if not self.version:
            return error_msg
        try:
            verdict = api_catalog.check_endpoint(f"/api/v2/{endpoint.lstrip('/')}",
                                                 version=self.version, method=method)
        except Exception:  # catalog unavailable — never mask the original error
            return error_msg
        if verdict.get("supported") is not False:
            return error_msg
        hint = f"[version] {verdict['reason']}"
        if verdict.get("similar_endpoints"):
            hint += f"; similar endpoints: {', '.join(verdict['similar_endpoints'][:3])}"
        ...
        try:
            ...
            if response.status_code >= 400:
                ...
                raise FortiGateAPIError(
                    self._with_version_hint(error_msg, endpoint, method),
    ...
    #
    # This set is GENERATED from the shipped FortiOS Swagger bundles — the union
    # across every documented release, so slash-style calls normalise correctly
    # no matter which build the device runs. Regenerate the data files with
    # ``scripts/build_fortios_api_catalog.py`` to support a new release; the
    # literal below is only a fallback for an install without the data files.
    _DOT_PATH_MODULES_FALLBACK: frozenset[str] = frozenset({
    ...
    DOT_PATH_MODULES: frozenset[str] = _load_dot_path_modules(_DOT_PATH_MODULES_FALLBACK)
    ...
    def normalize_cmdb_path(path: str) -> str:
        ...
        clean = path.strip('/')
        parts = clean.split('/')
        modules = FortiGateAPI.DOT_PATH_MODULES
    ...
    # System endpoints
    async def get_system_status(self, vdom: str | None = None) -> dict[str, Any]:
    ...
    async def get_system_interface(self, vdom: str | None = None) -> dict[str, Any]:
    ...
    # Interface endpoints
    async def get_interfaces(self, vdom: str | None = None) -> dict[str, Any]:
        """Get interface configuration."""
        return await self._make_request("GET", "cmdb/system/interface", vdom=vdom)

    async def update_interface(self, name: str, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
        """Update interface configuration."""
        return await self._make_request("PUT", f"cmdb/system/interface/{urllib.parse.quote(name, safe='')}", data=data, vdom=vdom)

    async def get_interface_status(self, interface_name: str, vdom: str | None = None) -> dict[str, Any]:
    ...
    async def get_firewall_policies(self, vdom: str | None = None) -> dict[str, Any]:
        """Get firewall policies."""
        return await self._make_request("GET", "cmdb/firewall/policy", vdom=vdom)

    async def create_firewall_policy(self, policy_data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
        """Create new firewall policy."""
        return await self._make_request("POST", "cmdb/firewall/policy", data=policy_data, vdom=vdom)

    async def update_firewall_policy(self, policy_id: str, policy_data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
    ...
    async def get_firewall_policy_detail(self, policy_id: str, vdom: str | None = None) -> dict[str, Any]:
    ...
    async def delete_firewall_policy(self, policy_id: str, vdom: str | None = None) -> dict[str, Any]:
        """Delete firewall policy."""
        encoded_id = urllib.parse.quote(policy_id, safe='')
        return await self._make_request("DELETE", f"cmdb/firewall/policy/{encoded_id}", vdom=vdom)

    # Address object endpoints
    async def get_address_objects(self, vdom: str | None = None) -> dict[str, Any]:
        """Get address objects."""
        return await self._make_request("GET", "cmdb/firewall/address", vdom=vdom)

    async def create_address_object(self, address_data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
        """Create new address object."""
        return await self._make_request("POST", "cmdb/firewall/address", data=address_data, vdom=vdom)

    async def update_address_object(self, address_name: str, address_data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
    ...
    async def delete_address_object(self, address_name: str, vdom: str | None = None) -> dict[str, Any]:
        """Delete address object."""
        encoded_name = urllib.parse.quote(address_name, safe='')
        return await self._make_request("DELETE", f"cmdb/firewall/address/{encoded_name}", vdom=vdom)

    # Service object endpoints
    async def get_service_objects(self, vdom: str | None = None) -> dict[str, Any]:
        """Get service objects."""
        return await self._make_request("GET", "cmdb/firewall.service/custom", vdom=vdom)

    async def create_service_object(self, service_data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
        """Create new service object."""
        return await self._make_request("POST", "cmdb/firewall.service/custom", data=service_data, vdom=vdom)

    async def update_service_object(self, service_name: str, service_data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
    ...
    async def delete_service_object(self, service_name: str, vdom: str | None = None) -> dict[str, Any]:
        """Delete service object."""
        encoded_name = urllib.parse.quote(service_name, safe='')
        return await self._make_request("DELETE", f"cmdb/firewall.service/custom/{encoded_name}", vdom=vdom)

    # Routing endpoints
    async def get_static_routes(self, vdom: str | None = None) -> dict[str, Any]:
        """Get static routes."""
        return await self._make_request("GET", "cmdb/router/static", vdom=vdom)

    async def create_static_route(self, route_data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
        """Create new static route."""
        return await self._make_request("POST", "cmdb/router/static", data=route_data, vdom=vdom)

    async def update_static_route(self, route_id: str, route_data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
    ...
    async def delete_static_route(self, route_id: str, vdom: str | None = None) -> dict[str, Any]:
        """Delete static route."""
        encoded_id = urllib.parse.quote(route_id, safe='')
        return await self._make_request("DELETE", f"cmdb/router/static/{encoded_id}", vdom=vdom)

    async def get_static_route_detail(self, route_id: str, vdom: str | None = None) -> dict[str, Any]:
    ...
    async def get_routing_table(self, vdom: str | None = None) -> dict[str, Any]:
        """Get routing table."""
        return await self._make_request("GET", "monitor/router/ipv4", vdom=vdom)

    # Virtual IP endpoints
    async def get_virtual_ips(self, vdom: str | None = None) -> dict[str, Any]:
        """Get virtual IPs."""
        return await self._make_request("GET", "cmdb/firewall/vip", vdom=vdom)

    async def create_virtual_ip(self, vip_data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
        """Create new virtual IP."""
        return await self._make_request("POST", "cmdb/firewall/vip", data=vip_data, vdom=vdom)

    async def update_virtual_ip(self, vip_name: str, vip_data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
    ...
    async def delete_virtual_ip(self, vip_name: str, vdom: str | None = None) -> dict[str, Any]:
        """Delete virtual IP."""
        encoded_name = urllib.parse.quote(vip_name, safe='')
        return await self._make_request("DELETE", f"cmdb/firewall/vip/{encoded_name}", vdom=vdom)

    async def get_virtual_ip_detail(self, vip_name: str, vdom: str | None = None) -> dict[str, Any]:
    ...
    async def delete_addrgrp6(self, name: str, vdom: str | None = None) -> dict[str, Any]:
    ...
    async def get_service_groups(self, vdom: str | None = None) -> dict[str, Any]:
        """Get service groups."""
        return await self._make_request("GET", "cmdb/firewall.service/group", vdom=vdom)

    async def create_service_group(self, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
        """Create new service group."""
        return await self._make_request("POST", "cmdb/firewall.service/group", data=data, vdom=vdom)

    async def update_service_group(self, name: str, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
    ...
    async def delete_service_group(self, name: str, vdom: str | None = None) -> dict[str, Any]:
        """Delete service group."""
        encoded = urllib.parse.quote(name, safe='')
        return await self._make_request("DELETE", f"cmdb/firewall.service/group/{encoded}", vdom=vdom)

    # Schedule endpoints
    async def get_schedule_onetime(self, vdom: str | None = None) -> dict[str, Any]:
        """Get onetime schedules."""
        return await self._make_request("GET", "cmdb/firewall.schedule/onetime", vdom=vdom)

    async def create_schedule_onetime(self, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
        """Create new onetime schedule."""
        return await self._make_request("POST", "cmdb/firewall.schedule/onetime", data=data, vdom=vdom)

    async def update_schedule_onetime(self, name: str, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
    ...
    async def delete_schedule_onetime(self, name: str, vdom: str | None = None) -> dict[str, Any]:
        """Delete onetime schedule."""
        encoded = urllib.parse.quote(name, safe='')
        return await self._make_request("DELETE", f"cmdb/firewall.schedule/onetime/{encoded}", vdom=vdom)

    async def get_schedule_recurring(self, vdom: str | None = None) -> dict[str, Any]:
    ...
    async def delete_schedule_recurring(self, name: str, vdom: str | None = None) -> dict[str, Any]:
        """Delete recurring schedule."""
        encoded = urllib.parse.quote(name, safe='')
        return await self._make_request("DELETE", f"cmdb/firewall.schedule/recurring/{encoded}", vdom=vdom)

    async def get_schedule_group(self, vdom: str | None = None) -> dict[str, Any]:
        """Get schedule groups."""
        return await self._make_request("GET", "cmdb/firewall.schedule/group", vdom=vdom)

    async def create_schedule_group(self, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
        """Create new schedule group."""
        return await self._make_request("POST", "cmdb/firewall.schedule/group", data=data, vdom=vdom)

    async def update_schedule_group(self, name: str, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
    ...
    async def update_wildcard_fqdn_custom(self, name: str, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
    ...
    async def delete_wildcard_fqdn_custom(self, name: str, vdom: str | None = None) -> dict[str, Any]:
    ...
    async def get_wildcard_fqdn_group(self, vdom: str | None = None) -> dict[str, Any]:
        """Get wildcard FQDN groups."""
        return await self._make_request("GET", "cmdb/firewall.wildcard-fqdn/group", vdom=vdom)

    async def create_wildcard_fqdn_group(self, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
        """Create new wildcard FQDN group."""
        return await self._make_request("POST", "cmdb/firewall.wildcard-fqdn/group", data=data, vdom=vdom)

    async def update_wildcard_fqdn_group(self, name: str, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
    ...
    async def delete_wildcard_fqdn_group(self, name: str, vdom: str | None = None) -> dict[str, Any]:
    ...
    async def get_traffic_shapers(self, vdom: str | None = None) -> dict[str, Any]:
        """Get traffic shapers."""
        return await self._make_request("GET", "cmdb/firewall.shaper/traffic-shaper", vdom=vdom)

    async def create_traffic_shaper(self, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
        """Create new traffic shaper."""
        return await self._make_request("POST", "cmdb/firewall.shaper/traffic-shaper", data=data, vdom=vdom)

    async def update_traffic_shaper(self, name: str, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
    ...
    async def delete_traffic_shaper(self, name: str, vdom: str | None = None) -> dict[str, Any]:
        """Delete traffic shaper."""
        encoded = urllib.parse.quote(name, safe='')
        return await self._make_request("DELETE", f"cmdb/firewall.shaper/traffic-shaper/{encoded}", vdom=vdom)

    async def get_per_ip_shapers(self, vdom: str | None = None) -> dict[str, Any]:
        """Get per-IP traffic shapers."""
        return await self._make_request("GET", "cmdb/firewall.shaper/per-ip-shaper", vdom=vdom)

    async def create_per_ip_shaper(self, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
    ...
    async def update_per_ip_shaper(self, name: str, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
    ...
    async def delete_per_ip_shaper(self, name: str, vdom: str | None = None) -> dict[str, Any]:
    ...
    async def get_central_snat_maps(self, vdom: str | None = None) -> dict[str, Any]:
        """Get central SNAT maps."""
        return await self._make_request("GET", "cmdb/firewall/central-snat-map", vdom=vdom)

    async def create_central_snat_map(self, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
        """Create new central SNAT map."""
        return await self._make_request("POST", "cmdb/firewall/central-snat-map", data=data, vdom=vdom)

    async def update_central_snat_map(self, policy_id: str, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
    ...
    async def delete_central_snat_map(self, policy_id: str, vdom: str | None = None) -> dict[str, Any]:
        """Delete central SNAT map."""
        encoded = urllib.parse.quote(policy_id, safe='')
        return await self._make_request("DELETE", f"cmdb/firewall/central-snat-map/{encoded}", vdom=vdom)

    async def get_central_snat_map_detail(self, policy_id: str, vdom: str | None = None) -> dict[str, Any]:
    ...
    async def get_security_policies(self, vdom: str | None = None) -> dict[str, Any]:
        """Get security policies."""
        return await self._make_request("GET", "cmdb/firewall/security-policy", vdom=vdom)

    async def create_security_policy(self, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
        """Create new security policy."""
        return await self._make_request("POST", "cmdb/firewall/security-policy", data=data, vdom=vdom)

    async def update_security_policy(self, policy_id: str, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
    ...
    async def delete_security_policy(self, policy_id: str, vdom: str | None = None) -> dict[str, Any]:
        """Delete security policy."""
        encoded = urllib.parse.quote(policy_id, safe='')
        return await self._make_request("DELETE", f"cmdb/firewall/security-policy/{encoded}", vdom=vdom)

    async def get_security_policy_detail(self, policy_id: str, vdom: str | None = None) -> dict[str, Any]:
    ...
    async def get_proxy_policies(self, vdom: str | None = None) -> dict[str, Any]:
        """Get proxy policies."""
        return await self._make_request("GET", "cmdb/firewall/proxy-policy", vdom=vdom)

    async def create_proxy_policy(self, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
        """Create new proxy policy."""
        return await self._make_request("POST", "cmdb/firewall/proxy-policy", data=data, vdom=vdom)

    async def update_proxy_policy(self, policy_id: str, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
        """Update existing proxy policy."""
        encoded = urllib.parse.quote(policy_id, safe='')
        return await self._make_request("PUT", f"cmdb/firewall/proxy-policy/{encoded}", data=data, vdom=vdom)

    async def delete_proxy_policy(self, policy_id: str, vdom: str | None = None) -> dict[str, Any]:
        """Delete proxy policy."""
        encoded = urllib.parse.quote(policy_id, safe='')
        return await self._make_request("DELETE", f"cmdb/firewall/proxy-policy/{encoded}", vdom=vdom)

    async def get_proxy_policy_detail(self, policy_id: str, vdom: str | None = None) -> dict[str, Any]:
    ...
    async def get_proxy_addresses(self, vdom: str | None = None) -> dict[str, Any]:
        """Get proxy addresses."""
        return await self._make_request("GET", "cmdb/firewall/proxy-address", vdom=vdom)

    async def create_proxy_address(self, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
        """Create new proxy address."""
        return await self._make_request("POST", "cmdb/firewall/proxy-address", data=data, vdom=vdom)

    async def update_proxy_address(self, name: str, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
    ...
    async def delete_proxy_address(self, name: str, vdom: str | None = None) -> dict[str, Any]:
    ...
    async def get_proxy_addrgrps(self, vdom: str | None = None) -> dict[str, Any]:
        """Get proxy address groups."""
        return await self._make_request("GET", "cmdb/firewall/proxy-addrgrp", vdom=vdom)

    async def create_proxy_addrgrp(self, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
        """Create new proxy address group."""
        return await self._make_request("POST", "cmdb/firewall/proxy-addrgrp", data=data, vdom=vdom)

    async def update_proxy_addrgrp(self, name: str, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
    ...
    async def delete_proxy_addrgrp(self, name: str, vdom: str | None = None) -> dict[str, Any]:
    ...
    async def get_shaping_policies(self, vdom: str | None = None) -> dict[str, Any]:
        """Get shaping policies."""
        return await self._make_request("GET", "cmdb/firewall/shaping-policy", vdom=vdom)

    async def create_shaping_policy(self, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
        """Create new shaping policy."""
        return await self._make_request("POST", "cmdb/firewall/shaping-policy", data=data, vdom=vdom)

    async def update_shaping_policy(self, policy_id: str, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
    ...
    async def delete_shaping_policy(self, policy_id: str, vdom: str | None = None) -> dict[str, Any]:
    ...
    async def get_shaping_profiles(self, vdom: str | None = None) -> dict[str, Any]:
        """Get shaping profiles."""
        return await self._make_request("GET", "cmdb/firewall/shaping-profile", vdom=vdom)

    async def create_shaping_profile(self, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
        """Create new shaping profile."""
        return await self._make_request("POST", "cmdb/firewall/shaping-profile", data=data, vdom=vdom)

    async def update_shaping_profile(self, name: str, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
    ...
    async def delete_shaping_profile(self, name: str, vdom: str | None = None) -> dict[str, Any]:
    ...
    async def delete_local_in_policy(self, policy_id: str, vdom: str | None = None) -> dict[str, Any]:
    ...
    async def get_interface_policies(self, vdom: str | None = None) -> dict[str, Any]:
        """Get interface policies."""
        return await self._make_request("GET", "cmdb/firewall/interface-policy", vdom=vdom)

    async def create_interface_policy(self, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
        """Create new interface policy."""
        return await self._make_request("POST", "cmdb/firewall/interface-policy", data=data, vdom=vdom)

    async def update_interface_policy(self, policy_id: str, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
    ...
    async def delete_interface_policy(self, policy_id: str, vdom: str | None = None) -> dict[str, Any]:
    ...
    async def get_multicast_policies(self, vdom: str | None = None) -> dict[str, Any]:
        """Get multicast policies."""
        return await self._make_request("GET", "cmdb/firewall/multicast-policy", vdom=vdom)

    async def create_multicast_policy(self, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
        """Create new multicast policy."""
        return await self._make_request("POST", "cmdb/firewall/multicast-policy", data=data, vdom=vdom)

    async def update_multicast_policy(self, policy_id: str, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
    ...
    async def delete_multicast_policy(self, policy_id: str, vdom: str | None = None) -> dict[str, Any]:
    ...
    async def get_multicast_addresses(self, vdom: str | None = None) -> dict[str, Any]:
        """Get multicast addresses."""
        return await self._make_request("GET", "cmdb/firewall/multicast-address", vdom=vdom)

    async def create_multicast_address(self, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
        """Create new multicast address."""
        return await self._make_request("POST", "cmdb/firewall/multicast-address", data=data, vdom=vdom)

    async def update_multicast_address(self, name: str, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
    ...
    async def delete_multicast_address(self, name: str, vdom: str | None = None) -> dict[str, Any]:
        """Delete multicast address."""
        encoded = urllib.parse.quote(name, safe='')
        return await self._make_request("DELETE", f"cmdb/firewall/multicast-address/{encoded}", vdom=vdom)

    # Sniffer endpoints
    async def get_sniffers(self, vdom: str | None = None) -> dict[str, Any]:
        """Get sniffers."""
        return await self._make_request("GET", "cmdb/firewall/sniffer", vdom=vdom)

    async def create_sniffer(self, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
        """Create new sniffer."""
        return await self._make_request("POST", "cmdb/firewall/sniffer", data=data, vdom=vdom)

    async def update_sniffer(self, sniffer_id: str, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
    ...
    async def delete_sniffer(self, sniffer_id: str, vdom: str | None = None) -> dict[str, Any]:
        """Delete sniffer."""
        encoded = urllib.parse.quote(sniffer_id, safe='')
        return await self._make_request("DELETE", f"cmdb/firewall/sniffer/{encoded}", vdom=vdom)

    # IP Translation endpoints
    async def get_ip_translations(self, vdom: str | None = None) -> dict[str, Any]:
        """Get IP translations."""
        return await self._make_request("GET", "cmdb/firewall/ip-translation", vdom=vdom)

    async def create_ip_translation(self, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
        """Create new IP translation."""
        return await self._make_request("POST", "cmdb/firewall/ip-translation", data=data, vdom=vdom)

    async def update_ip_translation(self, trans_id: str, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
    ...
    async def delete_ip_translation(self, trans_id: str, vdom: str | None = None) -> dict[str, Any]:
    ...
    async def get_identity_based_routes(self, vdom: str | None = None) -> dict[str, Any]:
        """Get identity-based routes."""
        return await self._make_request("GET", "cmdb/firewall/identity-based-route", vdom=vdom)

    async def create_identity_based_route(self, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
    ...
    async def update_identity_based_route(self, name: str, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
    ...
    async def delete_identity_based_route(self, name: str, vdom: str | None = None) -> dict[str, Any]:
    ...
    async def get_ssl_ssh_profiles(self, vdom: str | None = None) -> dict[str, Any]:
        """Get SSL/SSH profiles."""
        return await self._make_request("GET", "cmdb/firewall/ssl-ssh-profile", vdom=vdom)

    async def create_ssl_ssh_profile(self, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
        """Create new SSL/SSH profile."""
        return await self._make_request("POST", "cmdb/firewall/ssl-ssh-profile", data=data, vdom=vdom)

    async def update_ssl_ssh_profile(self, name: str, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
    ...
    async def delete_ssl_ssh_profile(self, name: str, vdom: str | None = None) -> dict[str, Any]:
    ...
    async def delete_profile_group(self, name: str, vdom: str | None = None) -> dict[str, Any]:
    ...
    async def get_profile_protocol_options(self, vdom: str | None = None) -> dict[str, Any]:
        """Get profile protocol options."""
        return await self._make_request("GET", "cmdb/firewall/profile-protocol-options", vdom=vdom)

    async def create_profile_protocol_options(self, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
    ...
    async def update_profile_protocol_options(self, name: str, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
    ...
    async def delete_profile_protocol_options(self, name: str, vdom: str | None = None) -> dict[str, Any]:
    ...
    async def get_firewall_global(self, vdom: str | None = None) -> dict[str, Any]:
        """Get firewall global settings."""
        return await self._make_request("GET", "cmdb/firewall/global", vdom=vdom)

    async def update_firewall_global(self, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
    ...
    async def get_decrypted_traffic_mirrors(self, vdom: str | None = None) -> dict[str, Any]:
        """Get decrypted traffic mirrors."""
        return await self._make_request("GET", "cmdb/firewall/decrypted-traffic-mirror", vdom=vdom)

    async def create_decrypted_traffic_mirror(self, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
    ...
    async def update_decrypted_traffic_mirror(self, name: str, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
    ...
    async def delete_decrypted_traffic_mirror(self, name: str, vdom: str | None = None) -> dict[str, Any]:
    ...
    async def get_dns_translations(self, vdom: str | None = None) -> dict[str, Any]:
        """Get DNS translations."""
        return await self._make_request("GET", "cmdb/firewall/dnstranslation", vdom=vdom)

    async def create_dns_translation(self, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
        """Create new DNS translation."""
        return await self._make_request("POST", "cmdb/firewall/dnstranslation", data=data, vdom=vdom)

    async def update_dns_translation(self, translation_id: str, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
    ...
    async def delete_dns_translation(self, translation_id: str, vdom: str | None = None) -> dict[str, Any]:
    ...
    async def get_ttl_policies(self, vdom: str | None = None) -> dict[str, Any]:
        """Get TTL policies."""
        return await self._make_request("GET", "cmdb/firewall/ttl-policy", vdom=vdom)

    async def create_ttl_policy(self, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
        """Create new TTL policy."""
        return await self._make_request("POST", "cmdb/firewall/ttl-policy", data=data, vdom=vdom)

    async def update_ttl_policy(self, policy_id: str, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
        """Update existing TTL policy."""
        encoded = urllib.parse.quote(policy_id, safe='')
        return await self._make_request("PUT", f"cmdb/firewall/ttl-policy/{encoded}", data=data, vdom=vdom)

    async def delete_ttl_policy(self, policy_id: str, vdom: str | None = None) -> dict[str, Any]:
        """Delete TTL policy."""
        encoded = urllib.parse.quote(policy_id, safe='')
    ...
    # ============================================================
    async def get_certificate_ca(self, vdom: str | None = None) -> dict[str, Any]:
        """Get CA certificates."""
        return await self._make_request("GET", "cmdb/certificate/ca", vdom=vdom)

    async def update_certificate_ca(self, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
        """Update CA certificates."""
        return await self._make_request("PUT", "cmdb/certificate/ca", data=data, vdom=vdom)

    async def get_certificate_local(self, vdom: str | None = None) -> dict[str, Any]:
        """Get local certificates."""
        return await self._make_request("GET", "cmdb/certificate/local", vdom=vdom)

    async def update_certificate_local(self, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
        """Update local certificates."""
        return await self._make_request("PUT", "cmdb/certificate/local", data=data, vdom=vdom)

    async def get_certificate_remote(self, vdom: str | None = None) -> dict[str, Any]:
        """Get remote certificates."""
        return await self._make_request("GET", "cmdb/certificate/remote", vdom=vdom)

    async def update_certificate_remote(self, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
        """Update remote certificates."""
        return await self._make_request("PUT", "cmdb/certificate/remote", data=data, vdom=vdom)

    async def get_certificate_crl(self, vdom: str | None = None) -> dict[str, Any]:
        """Get certificate CRL."""
        return await self._make_request("GET", "cmdb/certificate/crl", vdom=vdom)

    async def update_certificate_crl(self, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
    ...
    async def delete_dnsfilter_domain_filter(self, filt_id: str, vdom: str | None = None) -> dict[str, Any]:
    ...
    # DLP endpoints
    # ============================================================
    async def get_dlp_sensors(self, vdom: str | None = None) -> dict[str, Any]:
        """Get DLP sensors."""
        return await self._make_request("GET", "cmdb/dlp/sensor", vdom=vdom)

    async def create_dlp_sensor(self, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
        """Create DLP sensor."""
        return await self._make_request("POST", "cmdb/dlp/sensor", data=data, vdom=vdom)

    async def update_dlp_sensor(self, name: str, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
        """Update DLP sensor."""
        encoded = urllib.parse.quote(name, safe='')
        return await self._make_request("PUT", f"cmdb/dlp/sensor/{encoded}", data=data, vdom=vdom)

    async def delete_dlp_sensor(self, name: str, vdom: str | None = None) -> dict[str, Any]:
        """Delete DLP sensor."""
        encoded = urllib.parse.quote(name, safe='')
        return await self._make_request("DELETE", f"cmdb/dlp/sensor/{encoded}", vdom=vdom)

    async def get_dlp_profiles(self, vdom: str | None = None) -> dict[str, Any]:
        """Get DLP profiles."""
        return await self._make_request("GET", "cmdb/dlp/profile", vdom=vdom)

    async def create_dlp_profile(self, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
        """Create DLP profile."""
        return await self._make_request("POST", "cmdb/dlp/profile", data=data, vdom=vdom)

    async def update_dlp_profile(self, name: str, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
        """Update DLP profile."""
        encoded = urllib.parse.quote(name, safe='')
        return await self._make_request("PUT", f"cmdb/dlp/profile/{encoded}", data=data, vdom=vdom)

    async def delete_dlp_profile(self, name: str, vdom: str | None = None) -> dict[str, Any]:
        """Delete DLP profile."""
        encoded = urllib.parse.quote(name, safe='')
        return await self._make_request("DELETE", f"cmdb/dlp/profile/{encoded}", vdom=vdom)

    async def get_dlp_settings(self, vdom: str | None = None) -> dict[str, Any]:
        """Get DLP settings."""
        return await self._make_request("GET", "cmdb/dlp/settings", vdom=vdom)

    async def update_dlp_settings(self, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
        """Update DLP settings."""
        return await self._make_request("PUT", "cmdb/dlp/settings", data=data, vdom=vdom)

    async def get_dlp_filepatterns(self, vdom: str | None = None) -> dict[str, Any]:
        """Get DLP file patterns."""
        return await self._make_request("GET", "cmdb/dlp/filepattern", vdom=vdom)

    async def create_dlp_filepattern(self, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
        """Create DLP file pattern."""
        return await self._make_request("POST", "cmdb/dlp/filepattern", data=data, vdom=vdom)

    async def update_dlp_filepattern(self, filt_id: str, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
        """Update DLP file pattern."""
        encoded = urllib.parse.quote(filt_id, safe='')
        return await self._make_request("PUT", f"cmdb/dlp/filepattern/{encoded}", data=data, vdom=vdom)

    async def delete_dlp_filepattern(self, filt_id: str, vdom: str | None = None) -> dict[str, Any]:
    ...
    # ============================================================
    async def get_automation_setting(self, vdom: str | None = None) -> dict[str, Any]:
        """Get automation settings."""
        return await self._make_request("GET", "cmdb/automation/setting", vdom=vdom)

    async def update_automation_setting(self, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
    ...
    # CASB endpoints
    # ============================================================
    async def get_casb_profiles(self, vdom: str | None = None) -> dict[str, Any]:
        """Get CASB profiles."""
        return await self._make_request("GET", "cmdb/casb/profile", vdom=vdom)

    async def create_casb_profile(self, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
        """Create CASB profile."""
        return await self._make_request("POST", "cmdb/casb/profile", data=data, vdom=vdom)

    async def update_casb_profile(self, name: str, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
        """Update CASB profile."""
        encoded = urllib.parse.quote(name, safe='')
        return await self._make_request("PUT", f"cmdb/casb/profile/{encoded}", data=data, vdom=vdom)

    async def delete_casb_profile(self, name: str, vdom: str | None = None) -> dict[str, Any]:
        """Delete CASB profile."""
        encoded = urllib.parse.quote(name, safe='')
        return await self._make_request("DELETE", f"cmdb/casb/profile/{encoded}", vdom=vdom)

    async def get_casb_saas_applications(self, vdom: str | None = None) -> dict[str, Any]:
        """Get CASB SaaS applications."""
        return await self._make_request("GET", "cmdb/casb/saas-application", vdom=vdom)

    async def create_casb_saas_application(self, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
        """Create CASB SaaS application."""
        return await self._make_request("POST", "cmdb/casb/saas-application", data=data, vdom=vdom)

    async def update_casb_saas_application(self, name: str, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
        """Update CASB SaaS application."""
        encoded = urllib.parse.quote(name, safe='')
        return await self._make_request("PUT", f"cmdb/casb/saas-application/{encoded}", data=data, vdom=vdom)

    async def delete_casb_saas_application(self, name: str, vdom: str | None = None) -> dict[str, Any]:
    ...
    # ============================================================
    async def get_endpoint_control_settings(self, vdom: str | None = None) -> dict[str, Any]:
        """Get endpoint control settings."""
        return await self._make_request("GET", "cmdb/endpoint-control/settings", vdom=vdom)

    async def update_endpoint_control_settings(self, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
    ...
    # ============================================================
    async def get_diameter_filter_profiles(self, vdom: str | None = None) -> dict[str, Any]:
        """Get diameter filter profiles."""
        return await self._make_request("GET", "cmdb/diameter-filter/profile", vdom=vdom)

    async def create_diameter_filter_profile(self, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
        """Create diameter filter profile."""
        return await self._make_request("POST", "cmdb/diameter-filter/profile", data=data, vdom=vdom)

    async def update_diameter_filter_profile(self, name: str, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
    ...
    async def delete_diameter_filter_profile(self, name: str, vdom: str | None = None) -> dict[str, Any]:
    ...
    # ============================================================
    async def get_ethernet_oam_cfm(self, vdom: str | None = None) -> dict[str, Any]:
        """Get Ethernet OAM CFM configuration."""
        return await self._make_request("GET", "cmdb/ethernet-oam/cfm", vdom=vdom)

    async def create_ethernet_oam_cfm(self, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
        """Create Ethernet OAM CFM."""
        return await self._make_request("POST", "cmdb/ethernet-oam/cfm", data=data, vdom=vdom)

    async def update_ethernet_oam_cfm(self, name: str, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
        """Update Ethernet OAM CFM."""
        encoded = urllib.parse.quote(name, safe='')
        return await self._make_request("PUT", f"cmdb/ethernet-oam/cfm/{encoded}", data=data, vdom=vdom)

    async def delete_ethernet_oam_cfm(self, name: str, vdom: str | None = None) -> dict[str, Any]:
    ...
    # ============================================================
    async def get_application_custom(self, vdom: str | None = None) -> dict[str, Any]:
        """Get custom application signatures."""
        return await self._make_request("GET", "cmdb/application/custom", vdom=vdom)

    async def create_application_custom(self, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
        """Create custom application signature."""
        return await self._make_request("POST", "cmdb/application/custom", data=data, vdom=vdom)

    async def update_application_custom(self, tag: str, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
    ...
    async def delete_antivirus_exempt_list(self, entry_id: str, vdom: str | None = None) -> dict[str, Any]:
        """Delete antivirus exempt list entry."""
        encoded = urllib.parse.quote(entry_id, safe='')
        return await self._make_request("DELETE", f"cmdb/antivirus/exempt-list/{encoded}", vdom=vdom)

    async def get_antivirus_quarantine(self, vdom: str | None = None) -> dict[str, Any]:
        """Get antivirus quarantine settings."""
        return await self._make_request("GET", "cmdb/antivirus/quarantine", vdom=vdom)

    async def update_antivirus_quarantine(self, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
    ...
    # ============================================================
    async def get_alertemail_setting(self, vdom: str | None = None) -> dict[str, Any]:
        """Get alert email settings."""
        return await self._make_request("GET", "cmdb/alertemail/setting", vdom=vdom)

    async def update_alertemail_setting(self, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
    ...
    # ============================================================
    async def get_ssh_filter_profiles(self, vdom: str | None = None) -> dict[str, Any]:
        """Get SSH filter profiles."""
        return await self._make_request("GET", "cmdb/ssh-filter/profile", vdom=vdom)

    async def create_ssh_filter_profile(self, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
        """Create SSH filter profile."""
        return await self._make_request("POST", "cmdb/ssh-filter/profile", data=data, vdom=vdom)

    async def update_ssh_filter_profile(self, name: str, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
        """Update SSH filter profile."""
        encoded = urllib.parse.quote(name, safe='')
        return await self._make_request("PUT", f"cmdb/ssh-filter/profile/{encoded}", data=data, vdom=vdom)

    async def delete_ssh_filter_profile(self, name: str, vdom: str | None = None) -> dict[str, Any]:
    ...
    # ============================================================
    async def get_sctp_filter_profiles(self, vdom: str | None = None) -> dict[str, Any]:
        """Get SCTP filter profiles."""
        return await self._make_request("GET", "cmdb/sctp-filter/profile", vdom=vdom)

    async def create_sctp_filter_profile(self, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
        """Create SCTP filter profile."""
        return await self._make_request("POST", "cmdb/sctp-filter/profile", data=data, vdom=vdom)

    async def update_sctp_filter_profile(self, name: str, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
        """Update SCTP filter profile."""
        encoded = urllib.parse.quote(name, safe='')
        return await self._make_request("PUT", f"cmdb/sctp-filter/profile/{encoded}", data=data, vdom=vdom)

    async def delete_sctp_filter_profile(self, name: str, vdom: str | None = None) -> dict[str, Any]:
    ...
    # ============================================================
    async def get_switch_acl_groups(self, vdom: str | None = None) -> dict[str, Any]:
        """Get switch ACL groups."""
        return await self._make_request("GET", "cmdb/switch-controller.acl/group", vdom=vdom)

    async def create_switch_acl_group(self, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
        """Create switch ACL group."""
        return await self._make_request("POST", "cmdb/switch-controller.acl/group", data=data, vdom=vdom)

    async def update_switch_acl_group(self, name: str, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
    ...
    async def delete_switch_acl_group(self, name: str, vdom: str | None = None) -> dict[str, Any]:
        """Delete switch ACL group."""
        encoded = urllib.parse.quote(name, safe='')
        return await self._make_request("DELETE", f"cmdb/switch-controller.acl/group/{encoded}", vdom=vdom)

    async def get_switch_acl_ingress(self, vdom: str | None = None) -> dict[str, Any]:
        """Get switch ingress ACL policies."""
        return await self._make_request("GET", "cmdb/switch-controller.acl/ingress", vdom=vdom)

    async def create_switch_acl_ingress(self, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
        """Create switch ingress ACL."""
        return await self._make_request("POST", "cmdb/switch-controller.acl/ingress", data=data, vdom=vdom)

    async def update_switch_acl_ingress(self, policy_id: str, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
    ...
    async def delete_switch_acl_ingress(self, policy_id: str, vdom: str | None = None) -> dict[str, Any]:
    ...
    # ============================================================
    async def get_switch_auto_config_custom(self, vdom: str | None = None) -> dict[str, Any]:
    ...
    async def create_switch_auto_config_custom(self, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
    ...
    async def update_switch_auto_config_custom(self, name: str, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
    ...
    async def delete_switch_auto_config_custom(self, name: str, vdom: str | None = None) -> dict[str, Any]:
    ...
    async def get_switch_auto_config_default(self, vdom: str | None = None) -> dict[str, Any]:
        """Get switch auto-config default."""
        return await self._make_request("GET", "cmdb/switch-controller.auto-config/default", vdom=vdom)

    async def update_switch_auto_config_default(self, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
    ...
    async def get_switch_auto_config_policy(self, vdom: str | None = None) -> dict[str, Any]:
        """Get switch auto-config policies."""
        return await self._make_request("GET", "cmdb/switch-controller.auto-config/policy", vdom=vdom)

    async def create_switch_auto_config_policy(self, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
    ...
    async def update_switch_auto_config_policy(self, name: str, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
    ...
    async def delete_switch_auto_config_policy(self, name: str, vdom: str | None = None) -> dict[str, Any]:
    ...
    # ============================================================
    async def get_switch_qos_dot1p_map(self, vdom: str | None = None) -> dict[str, Any]:
        """Get switch QoS dot1p map."""
        return await self._make_request("GET", "cmdb/switch-controller.qos/dot1p-map", vdom=vdom)

    async def create_switch_qos_dot1p_map(self, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
        """Create switch QoS dot1p map."""
        return await self._make_request("POST", "cmdb/switch-controller.qos/dot1p-map", data=data, vdom=vdom)

    async def update_switch_qos_dot1p_map(self, name: str, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
    ...
    async def delete_switch_qos_dot1p_map(self, name: str, vdom: str | None = None) -> dict[str, Any]:
    ...
    async def get_switch_qos_ip_dscp_map(self, vdom: str | None = None) -> dict[str, Any]:
        """Get switch QoS IP DSCP map."""
        return await self._make_request("GET", "cmdb/switch-controller.qos/ip-dscp-map", vdom=vdom)

    async def create_switch_qos_ip_dscp_map(self, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
    ...
    async def update_switch_qos_ip_dscp_map(self, name: str, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
    ...
    async def delete_switch_qos_ip_dscp_map(self, name: str, vdom: str | None = None) -> dict[str, Any]:
    ...
    async def get_switch_qos_qos_policy(self, vdom: str | None = None) -> dict[str, Any]:
        """Get switch QoS policies."""
        return await self._make_request("GET", "cmdb/switch-controller.qos/qos-policy", vdom=vdom)

    async def create_switch_qos_qos_policy(self, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
        """Create switch QoS policy."""
        return await self._make_request("POST", "cmdb/switch-controller.qos/qos-policy", data=data, vdom=vdom)

    async def update_switch_qos_qos_policy(self, name: str, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
    ...
    async def delete_switch_qos_qos_policy(self, name: str, vdom: str | None = None) -> dict[str, Any]:
        """Delete switch QoS policy."""
        encoded = urllib.parse.quote(name, safe='')
        return await self._make_request("DELETE", f"cmdb/switch-controller.qos/qos-policy/{encoded}", vdom=vdom)

    async def get_switch_qos_queue_policy(self, vdom: str | None = None) -> dict[str, Any]:
        """Get switch QoS queue policies."""
        return await self._make_request("GET", "cmdb/switch-controller.qos/queue-policy", vdom=vdom)

    async def create_switch_qos_queue_policy(self, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
    ...
    async def update_switch_qos_queue_policy(self, name: str, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
    ...
    async def delete_switch_qos_queue_policy(self, name: str, vdom: str | None = None) -> dict[str, Any]:
    ...
    # ============================================================
    async def get_switch_8021x_policies(self, vdom: str | None = None) -> dict[str, Any]:
    ...
    async def create_switch_8021x_policy(self, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
    ...
    async def update_switch_8021x_policy(self, name: str, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
    ...
    async def delete_switch_8021x_policy(self, name: str, vdom: str | None = None) -> dict[str, Any]:
    ...
    async def get_switch_security_policy_local_access(self, vdom: str | None = None) -> dict[str, Any]:
    ...
    async def create_switch_security_policy_local_access(self, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
    ...
    async def update_switch_security_policy_local_access(self, name: str, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
    ...
    async def delete_switch_security_policy_local_access(self, name: str, vdom: str | None = None) -> dict[str, Any]:
    ...
    # ============================================================
    async def get_switch_initial_config_template(self, vdom: str | None = None) -> dict[str, Any]:
    ...
    async def create_switch_initial_config_template(self, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
    ...
    async def update_switch_initial_config_template(self, name: str, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
    ...
    async def delete_switch_initial_config_template(self, name: str, vdom: str | None = None) -> dict[str, Any]:
    ...
    async def get_switch_initial_config_vlans(self, vdom: str | None = None) -> dict[str, Any]:
        """Get switch initial config VLANs."""
        return await self._make_request("GET", "cmdb/switch-controller.initial-config/vlans", vdom=vdom)

    async def update_switch_initial_config_vlans(self, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
    ...
    # ============================================================
    async def get_switch_ptp_interface_policy(self, vdom: str | None = None) -> dict[str, Any]:
    ...
    async def create_switch_ptp_interface_policy(self, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
    ...
    async def update_switch_ptp_interface_policy(self, name: str, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
    ...
    async def delete_switch_ptp_interface_policy(self, name: str, vdom: str | None = None) -> dict[str, Any]:
    ...
    async def get_switch_ptp_profile(self, vdom: str | None = None) -> dict[str, Any]:
        """Get switch PTP profiles."""
        return await self._make_request("GET", "cmdb/switch-controller.ptp/profile", vdom=vdom)

    async def create_switch_ptp_profile(self, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
        """Create switch PTP profile."""
        return await self._make_request("POST", "cmdb/switch-controller.ptp/profile", data=data, vdom=vdom)

    async def update_switch_ptp_profile(self, name: str, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
    ...
    async def delete_switch_ptp_profile(self, name: str, vdom: str | None = None) -> dict[str, Any]:
    ...
    async def delete_web_proxy_forward_server_group(self, name: str, vdom: str | None = None) -> dict[str, Any]:
        return await self._make_request("DELETE", f"cmdb/web-proxy/forward-server-group/{urllib.parse.quote(name, safe='')}", vdom=vdom)

    async def get_web_proxy_explicit(self, vdom: str | None = None) -> dict[str, Any]:
        return await self._make_request("GET", "cmdb/web-proxy/explicit", vdom=vdom)

    async def update_web_proxy_explicit(self, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
        return await self._make_request("PUT", "cmdb/web-proxy/explicit", data=data, vdom=vdom)

    async def get_web_proxy_global(self, vdom: str | None = None) -> dict[str, Any]:
        return await self._make_request("GET", "cmdb/web-proxy/global", vdom=vdom)

    async def update_web_proxy_global(self, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
        return await self._make_request("PUT", "cmdb/web-proxy/global", data=data, vdom=vdom)

    # ============================================================
    # WAF endpoints
    # ============================================================
    async def get_waf_profiles(self, vdom: str | None = None) -> dict[str, Any]:
        return await self._make_request("GET", "cmdb/waf/profile", vdom=vdom)

    async def create_waf_profile(self, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
        return await self._make_request("POST", "cmdb/waf/profile", data=data, vdom=vdom)

    async def update_waf_profile(self, name: str, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
        return await self._make_request("PUT", f"cmdb/waf/profile/{urllib.parse.quote(name, safe='')}", data=data, vdom=vdom)

    async def delete_waf_profile(self, name: str, vdom: str | None = None) -> dict[str, Any]:
        return await self._make_request("DELETE", f"cmdb/waf/profile/{urllib.parse.quote(name, safe='')}", vdom=vdom)

    async def get_waf_signatures(self, vdom: str | None = None) -> dict[str, Any]:
        return await self._make_request("GET", "cmdb/waf/signature", vdom=vdom)

    # ============================================================
    # VoIP endpoints
    # ============================================================
    async def get_voip_profiles(self, vdom: str | None = None) -> dict[str, Any]:
        return await self._make_request("GET", "cmdb/voip/profile", vdom=vdom)

    async def create_voip_profile(self, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
        return await self._make_request("POST", "cmdb/voip/profile", data=data, vdom=vdom)

    async def update_voip_profile(self, name: str, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
        return await self._make_request("PUT", f"cmdb/voip/profile/{urllib.parse.quote(name, safe='')}", data=data, vdom=vdom)

    async def delete_voip_profile(self, name: str, vdom: str | None = None) -> dict[str, Any]:
        return await self._make_request("DELETE", f"cmdb/voip/profile/{urllib.parse.quote(name, safe='')}", vdom=vdom)

    # ============================================================
    # Video Filter endpoints
    # ============================================================
    async def get_videofilter_profiles(self, vdom: str | None = None) -> dict[str, Any]:
        return await self._make_request("GET", "cmdb/videofilter/profile", vdom=vdom)

    async def create_videofilter_profile(self, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
        return await self._make_request("POST", "cmdb/videofilter/profile", data=data, vdom=vdom)

    async def update_videofilter_profile(self, name: str, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
        return await self._make_request("PUT", f"cmdb/videofilter/profile/{urllib.parse.quote(name, safe='')}", data=data, vdom=vdom)

    async def delete_videofilter_profile(self, name: str, vdom: str | None = None) -> dict[str, Any]:
    ...
    # ============================================================
    async def get_virtual_patch_profiles(self, vdom: str | None = None) -> dict[str, Any]:
        return await self._make_request("GET", "cmdb/virtual-patch/profile", vdom=vdom)

    async def create_virtual_patch_profile(self, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
        return await self._make_request("POST", "cmdb/virtual-patch/profile", data=data, vdom=vdom)

    async def update_virtual_patch_profile(self, name: str, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
        return await self._make_request("PUT", f"cmdb/virtual-patch/profile/{urllib.parse.quote(name, safe='')}", data=data, vdom=vdom)

    async def delete_virtual_patch_profile(self, name: str, vdom: str | None = None) -> dict[str, Any]:
    ...
    # ============================================================
    async def get_system_snmp_communities(self, vdom: str | None = None) -> dict[str, Any]:
        return await self._make_request("GET", "cmdb/system.snmp/community", vdom=vdom)

    async def create_system_snmp_community(self, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
        return await self._make_request("POST", "cmdb/system.snmp/community", data=data, vdom=vdom)

    async def update_system_snmp_community(self, comm_id: str, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
        return await self._make_request("PUT", f"cmdb/system.snmp/community/{urllib.parse.quote(comm_id, safe='')}", data=data, vdom=vdom)

    async def delete_system_snmp_community(self, comm_id: str, vdom: str | None = None) -> dict[str, Any]:
        return await self._make_request("DELETE", f"cmdb/system.snmp/community/{urllib.parse.quote(comm_id, safe='')}", vdom=vdom)

    async def get_system_snmp_users(self, vdom: str | None = None) -> dict[str, Any]:
        return await self._make_request("GET", "cmdb/system.snmp/user", vdom=vdom)

    async def create_system_snmp_user(self, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
        return await self._make_request("POST", "cmdb/system.snmp/user", data=data, vdom=vdom)

    async def update_system_snmp_user(self, name: str, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
        return await self._make_request("PUT", f"cmdb/system.snmp/user/{urllib.parse.quote(name, safe='')}", data=data, vdom=vdom)

    async def delete_system_snmp_user(self, name: str, vdom: str | None = None) -> dict[str, Any]:
        return await self._make_request("DELETE", f"cmdb/system.snmp/user/{urllib.parse.quote(name, safe='')}", vdom=vdom)

    async def get_system_snmp_sysinfo(self, vdom: str | None = None) -> dict[str, Any]:
        return await self._make_request("GET", "cmdb/system.snmp/sysinfo", vdom=vdom)

    async def update_system_snmp_sysinfo(self, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
        return await self._make_request("PUT", "cmdb/system.snmp/sysinfo", data=data, vdom=vdom)

    # ============================================================
    # System - Auto Update Schedule
    # ============================================================
    async def get_system_autoupdate_schedule(self, vdom: str | None = None) -> dict[str, Any]:
        return await self._make_request("GET", "cmdb/system.autoupdate/schedule", vdom=vdom)

    async def update_system_autoupdate_schedule(self, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
        return await self._make_request("PUT", "cmdb/system.autoupdate/schedule", data=data, vdom=vdom)
    async def _make_log_request(self, endpoint: str, params: dict | None = None,
        ...
        try:
            ...
            raise FortiGateAPIError(f"Network error: {e!s}", device_id=self.device_id)

    async def _make_monitor_request(self, endpoint: str, params: dict | None = None,
                                     vdom: str | None = None,
                                     method: str = "GET",
    ...
    # ============================================================
    async def monitor_vpn_ipsec(self, vdom: str | None = None) -> dict[str, Any]:
        return await self._make_monitor_request("vpn/ipsec", vdom=vdom)

    async def monitor_vpn_ipsec_connection_count(self, vdom: str | None = None) -> dict[str, Any]:
        return await self._make_monitor_request("vpn/ipsec/connection-count", vdom=vdom)

    async def monitor_vpn_ssl(self, vdom: str | None = None) -> dict[str, Any]:
        return await self._make_monitor_request("vpn/ssl", vdom=vdom)

    async def monitor_vpn_ssl_stats(self, vdom: str | None = None) -> dict[str, Any]:
        return await self._make_monitor_request("vpn/ssl/stats", vdom=vdom)

    async def monitor_user_firewall(self, vdom: str | None = None) -> dict[str, Any]:
        return await self._make_monitor_request("user/firewall", vdom=vdom)

    async def monitor_user_firewall_count(self, vdom: str | None = None) -> dict[str, Any]:
        return await self._make_monitor_request("user/firewall/count", vdom=vdom)

    async def monitor_user_banned(self, vdom: str | None = None) -> dict[str, Any]:
        return await self._make_monitor_request("user/banned", vdom=vdom)

    async def monitor_user_fsso(self, vdom: str | None = None) -> dict[str, Any]:
        return await self._make_monitor_request("user/fsso", vdom=vdom)

    async def monitor_virtual_wan_health_check(self, vdom: str | None = None) -> dict[str, Any]:
        return await self._make_monitor_request("virtual-wan/health-check", vdom=vdom)

    async def monitor_virtual_wan_members(self, vdom: str | None = None) -> dict[str, Any]:
        return await self._make_monitor_request("virtual-wan/members", vdom=vdom)

    async def monitor_virtual_wan_sla_log(self, vdom: str | None = None) -> dict[str, Any]:
    ...
    async def monitor_utm_applications(self, vdom: str | None = None) -> dict[str, Any]:
        return await self._make_monitor_request("utm/applications", vdom=vdom)

    async def monitor_router_ipv4(self, vdom: str | None = None) -> dict[str, Any]:
        return await self._make_monitor_request("router/ipv4", vdom=vdom)

    async def monitor_router_ipv6(self, vdom: str | None = None) -> dict[str, Any]:
        return await self._make_monitor_request("router/ipv6", vdom=vdom)

    async def monitor_firewall_acl(self, vdom: str | None = None) -> dict[str, Any]:
        return await self._make_monitor_request("firewall/acl", vdom=vdom)

    async def monitor_firewall_acl6(self, vdom: str | None = None) -> dict[str, Any]:
    ...
    async def monitor_log_current_disk_usage(self, vdom: str | None = None) -> dict[str, Any]:
        return await self._make_monitor_request("log/current-disk-usage", vdom=vdom)

    async def monitor_log_fortianalyzer(self, vdom: str | None = None) -> dict[str, Any]:
        return await self._make_monitor_request("log/fortianalyzer", vdom=vdom)

    async def monitor_log_forticloud(self, vdom: str | None = None) -> dict[str, Any]:
        return await self._make_monitor_request("log/forticloud", vdom=vdom)

    async def monitor_ips_rate_based(self, vdom: str | None = None) -> dict[str, Any]:
        return await self._make_monitor_request("ips/rate-based", vdom=vdom)

    async def monitor_ips_session_performance(self, vdom: str | None = None) -> dict[str, Any]:
    ...
    async def monitor_fortiview_realtime_stats(self, vdom: str | None = None) -> dict[str, Any]:
        return await self._make_monitor_request("fortiview/realtime-statistics", vdom=vdom)

    async def monitor_network_arp(self, vdom: str | None = None) -> dict[str, Any]:
        return await self._make_monitor_request("network/arp", vdom=vdom)

    async def monitor_network_lldp_neighbors(self, vdom: str | None = None) -> dict[str, Any]:
    ...
    async def monitor_router_bgp_neighbors(self, vdom: str | None = None) -> dict[str, Any]:
        return await self._make_monitor_request("router/bgp/neighbors", vdom=vdom)

    async def monitor_router_bgp_paths(self, vdom: str | None = None) -> dict[str, Any]:
        return await self._make_monitor_request("router/bgp/paths", vdom=vdom)

    async def monitor_system_available_interfaces(self, vdom: str | None = None) -> dict[str, Any]:
    ...
    async def monitor_webfilter_fortiguard_categories(self, vdom: str | None = None) -> dict[str, Any]:
    ...
    async def monitor_system_resource_usage(self, vdom: str | None = None,
    ...
    async def monitor_system_interface(self, vdom: str | None = None) -> dict[str, Any]:
    ...
    async def monitor_firewall_sessions(self, vdom: str | None = None) -> dict[str, Any]:
        """Get current session table."""
        return await self._make_monitor_request("firewall/sessions", vdom=vdom)

    async def monitor_firewall_policy_lookup(self, params: dict, vdom: str | None = None) -> dict[str, Any]:
    ...
    # --- Generic monitor ---
    async def monitor_request(self, endpoint: str, params: dict | None = None,
                               vdom: str | None = None,
                               method: str = "GET",
                               data: dict | None = None) -> dict[str, Any]:
    ...
    async def service_sniffer_list(self, vdom: str | None = None) -> dict[str, Any]:
        return await self._make_service_request("GET", "sniffer/list/", vdom=vdom)

    async def service_sniffer_start(self, data: dict[str, Any], vdom: str | None = None) -> dict[str, Any]:
        return await self._make_service_request("POST", "sniffer/start/", data=data, vdom=vdom)

    async def service_sniffer_stop(self, sniffer_id: str, vdom: str | None = None) -> dict[str, Any]:
        return await self._make_service_request("POST", "sniffer/stop/", data={"id": sniffer_id}, vdom=vdom)

    async def service_sniffer_download(self, sniffer_id: str, vdom: str | None = None) -> dict[str, Any]:
        return await self._make_service_request("POST", "sniffer/download/", data={"id": sniffer_id}, vdom=vdom)

    async def service_sniffer_delete(self, sniffer_id: str, vdom: str | None = None) -> dict[str, Any]:
        return await self._make_service_request("POST", "sniffer/delete/", data={"id": sniffer_id}, vdom=vdom)

    # Security Rating
    async def service_security_rating_report(self, vdom: str | None = None) -> dict[str, Any]:
        return await self._make_service_request("GET", "security-rating/report/", vdom=vdom)

    async def service_security_rating_recommendations(self, vdom: str | None = None) -> dict[str, Any]:
    ...
    # Topology
    async def service_topology_report(self, vdom: str | None = None) -> dict[str, Any]:
    ...
    # ============================================================
    async def get_logs(self, source: str, log_type: str, subtype: str | None = None,
                       filter_str: str | None = None, limit: int = 100,
                       vdom: str | None = None) -> dict[str, Any]:
    ...
    async def get_logs_raw(self, source: str, log_type: str, subtype: str | None = None,
                           filter_str: str | None = None, vdom: str | None = None) -> dict[str, Any]:
    ...
    async def get_log_archive(self, source: str, log_type: str, vdom: str | None = None) -> dict[str, Any]:
        """Get log archive listing."""
        endpoint = f"{source}/{log_type}/archive"
        return await self._make_log_request(endpoint, vdom=vdom)

    async def download_log_archive(self, source: str, log_type: str, vdom: str | None = None) -> dict[str, Any]:
        """Download log archive."""
        endpoint = f"{source}/{log_type}/archive-download"
        return await self._make_log_request(endpoint, vdom=vdom)

    async def get_virus_log_archive(self, source: str, vdom: str | None = None) -> dict[str, Any]:
